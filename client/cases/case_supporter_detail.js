...
class CaseSupporterDetail extends Component {
	renderNotes(){
	...
	onClickRelese(){
		...
		var receiver = "none";
		var status = "waitting for supporter processing";
		...
		return(
			<div className="container">
				<div className="jumbotron">
					...
					<button className="btn btn-primary" onClick={this.onClickDeveloper.bind(this)}>Case to Developer</button>
				</div>
